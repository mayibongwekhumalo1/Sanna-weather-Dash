...
router.get('/:id/forecast', asyncHandler(locationController.getLocationForecast));
router.get('/:id/weather/history', asyncHandler(locationController.getWeatherHistory));
router.get('/weather/by-city', asyncHandler(locationController.getWeatherByCity));
router.get('/forecast/by-city', asyncHandler(locationController.getForecastByCity));
